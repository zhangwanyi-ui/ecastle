...
const getHomeBannerData = async () => {
  bannerList.value = [
    { id: '1', type: 0, hrefUrl: '', imgUrl: '../../static/image/v2/m01.png', },
    { id: '2', type: 0, hrefUrl: '', imgUrl: '../../static/image/v2/m02.png', },
    { id: '3', type: 0, hrefUrl: '', imgUrl: '../../static/image/v2/m03.png', },
    { id: '4', type: 0, hrefUrl: '', imgUrl: '../../static/image/v2/m04.png', },
    { id: '5', type: 0, hrefUrl: '', imgUrl: '../../static/image/v2/m05.png', },
    { id: '6', type: 0, hrefUrl: '', imgUrl: '../../static/image/v2/m06.png', },
    { id: '7', type: 0, hrefUrl: '', imgUrl: '../../static/image/v2/m07.png', },
  ]
}
...
<template>
  <div class="view" ref="view" :style="{ width: appwidth + 'px' }">
    <div class="top">
      <image src="@/static/image/v2/b01.png" :style="{ width: appwidth + 'px', height: appwidth / 4.687 + 'px' }" />
    </div>
    <div class="main" :style="{ width: appwidth + 'px', height: appwidth * 1.127 + 'px' }">
      <aaswiper2 :list="bannerList" />
    </div>
  </div>
...
.view {
  margin: auto;
  height: 100%;
  background: url(@/static/image/v2/b00.png) no-repeat center/cover;
}
